...
$sentencia=$bd->prepare("INSERT INTO experiencia(id_exp, nom_empresa, tiempo_inicio, tiempo_fin, puesto, dni) VALUES(:id_exp,:nom_empresa,:tiempo_inicio,:tiempo_fin,:puesto,:dni);");
