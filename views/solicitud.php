...
<body>
  ...
  <tbody>
    ...
    <?php include_once("../php/listar_solicitud.php");?>
    ...
    <tr class="text-center">
      ...
      <td><?php echo $solicitud->cod_cliente;?></td>
      <td><?php echo $solicitud->cod_perfil;?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- FORMULARIO -->
        <form action="../php/insertar_solicitud.php" method="POST">
          <div class="form-group">
            <label>ID</label>
            <input type="integer" name="id_solicitud" class="form-control">
          </div>
...
<div class="modal fade" id="editar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- FORMULARIO -->
        <form action="../php/editar_solicitud.php" method="POST">
          <input type="hidden" name="id_solicitud" id="update_id">
          

           <div class="form-group">
            <label>CÓDIGO DEL CLIENTE</label>
            <input type="integer" name="cod_cliente" id="cod_cliente" class="form-control">
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"> <!-- AQUI SE REALIZARÁ LA BAJA -->
        ...
        <form action="../php/eliminar_solicitud.php" method="POST">
        <input type="hidden" name="id_solicitud" id="eliminar_id"> <!-- DE TIPO HIDDEN PARA OCULTAR LOS DATOS --> 
...
<!-- AQUI NOS MOSTRARÁ INFORMACIÓN DE 3 TABLAS JUNTAS, PARA SABER QUE CLIENTE Y PERFIL SE SOLICITAN -->
  <center><h4>Selección para saber el nombre del cliente y descripción del perfil</h4> 
<center><table class="table table-hover" style="width: 50rem;">
    <thead>
        <tr>
            <th>RESUMEN DE SOLICITUDES</th>
        </tr>
    </thead>
    <tbody id="form-list-client-body">
        <?php
        include_once("../php/conexion.php");
        $query = "SELECT solicita.id_solicitud, cliente.nombre, perfil.descripcion FROM solicita INNER JOIN cliente INNER JOIN perfil ON cliente.cod_cliente = solicita.cod_cliente AND solicita.cod_perfil = perfil.cod_perfil";
        $sentencia= $bd -> prepare($query);
        $sentencia->execute();
        ?>
        <tr>
        <td><?php foreach($sentencia as $solicita) echo $solicita['id_solicitud'].' | Cliente: '.$solicita['nombre'].' | Perfil: '.$solicita['descripcion'].'<br/>' ?></td>
        </tr>
    </tbody>
</table></center>
<br><br><br>
